...
public class Log4jXmlObjectMapper extends XmlMapper {
    ...
    private static final class SanitizingXmlFactory extends XmlFactory {
        ...
        // Upstream's copy constructor takes a seventh argument, the jackson 2.14 XmlNameProcessor,
        // and forwards it to an XmlFactory constructor of the same arity. Neither exists in the
        // jackson 2.13.1 this release builds against, so both are dropped; every other argument,
        // and the field each is read from, is upstream's.
